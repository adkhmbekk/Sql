...
select EmployeeID, FirstName, LastName, DepartmentName, Salary, HireDate, Age, isnull(Email, 'noemail@example.com') as Email, Country from Employees
...
--11 i decided to create all necessary tables in advance
