...
SELECT DepartmentName, AVG(Salary) AS AvgSalary, COUNT(*) AS NumEmployees
FROM Employees
GROUP BY DepartmentName;
...
--извини у меня нет этой базы данных и таблицы надеюсь что простишь и оценишь достойно
